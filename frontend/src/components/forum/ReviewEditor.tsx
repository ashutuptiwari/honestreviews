...
export const ReviewEditor: React.FC<ReviewEditorProps> = ({
  ...
  return (
    <form onSubmit={handleSubmit} className="card">
      ...
      {/* Title (optional) */}
      <div className="mb-5">
        <label htmlFor="review-title" className="block text-sm font-medium text-light-text dark:text-dark-text mb-2">
      ...
      {/* Review Body */}
      <div className="mb-5">
        <label htmlFor="review-body" className="block text-sm font-medium text-light-text dark:text-dark-text mb-2">
      ...
      {(validationError || error) && (
        <div className="mb-5 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
          <p className="text-sm text-red-800 dark:text-red-300">{validationError || error}</p>
        </div>
      )}
